...
SEED = 7
CHECKPOINT_PATH = Path(f"model_checkpoints/lstm_{TARGET_HORIZON_DAYS}d_return_best.pt")
PREDICTIONS_PATH = Path(f"reports/lstm_{TARGET_HORIZON_DAYS}d_return_predictions.csv")
