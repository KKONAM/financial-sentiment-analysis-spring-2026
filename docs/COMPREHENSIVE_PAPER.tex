...
\textbf{Historical document note.} This comprehensive draft records earlier exploratory experiments, including RoBERTa, NewsAPI, binary next-day direction models, and 2026 validation. It is not the final CS 7643 paper protocol. The final reported experiment is in \texttt{financial-paper.tex}: a v6 five-trading-day return-regression grid using fine-tuned FinBERT StockTwits sentiment, purged chronological splits, and LSTM/GRU/Transformer sequence encoders. In that final run, sentiment-only Transformer has the lowest neural error (MAE 0.0470, RMSE 0.0647), sentiment-only LSTM has the strongest return correlation (0.2091), and no neural model beats the always-down directional baseline.
\end{minipage}}
\end{center}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{transformer_figures/sentiment_impact.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{transformer_figures/feature_ablation.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{transformer_figures/error_comparison.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.9\textwidth]{transformer_figures/model_comparison.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{transformer_figures/trading_performance.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{transformer_figures/2026_validation.pdf}
