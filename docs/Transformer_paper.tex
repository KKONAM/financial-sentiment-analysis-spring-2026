...
\midrule
1. Binary LSTM & LSTM & 52.27\% & AAPL (55.45\%) & Pass & Baseline \\
2. Combined Sentiment & LSTM & 53.87\% & TSLA (55.17\%) & Pass & +1.60\% improvement \\
3. Transformer & Transformer & \textbf{56.39\%} & \textbf{NVDA (62.26\%)} & Pass & +4.12\% over LSTM \\
4. Trajectory Clustering & LGBM & 59.54\% & -- & Pass & Best classifier \\
5. Multi-Class LSTM & LSTM & 33.22\% & -- & Fail & Severe overfitting \\
6. Gradient Boosting & LGBM & 59.26\% WR & -- & Pass & 7.10\% return (best) \\
7. Ensemble & Various & 53.30\% & -- & Fail & No improvement \\
8. 2026 Validation & LSTM & 48.71\% & NVDA (53.45\%) & Pass & -3.56\% degradation \\
\bottomrule
\end{tabular}
